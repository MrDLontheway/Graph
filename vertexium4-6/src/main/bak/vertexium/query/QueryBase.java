...
public abstract class QueryBase implements Query, SimilarToGraphQuery {
    ...
    private final org.vertexium.query.QueryParameters parameters;
    ...
    @Override
    public QueryResultsIterable<? extends org.vertexium.VertexiumObject> search() {
    ...
    public QueryResultsIterable<? extends org.vertexium.VertexiumObject> search(EnumSet<VertexiumObjectType> objectTypes, FetchHints fetchHints) {
        List<QueryResultsIterable<? extends org.vertexium.VertexiumObject>> items = new ArrayList<>();
    ...
    private static class SelectManySearch
            extends SelectManyIterable<QueryResultsIterable<? extends org.vertexium.VertexiumObject>, org.vertexium.VertexiumObject>
            implements QueryResultsIterable<org.vertexium.VertexiumObject> {
        public SelectManySearch(Iterable<? extends QueryResultsIterable<? extends org.vertexium.VertexiumObject>> source) {
            super(source);
        }
        ...
        @Override
        protected Iterable<? extends org.vertexium.VertexiumObject> getIterable(QueryResultsIterable<? extends org.vertexium.VertexiumObject> source) {
            return source;
        }
    }
     ...
     */
    protected QueryResultsIterable<? extends org.vertexium.VertexiumObject> extendedData(FetchHints fetchHints) {
        throw new VertexiumException("not implemented");
    }

    protected QueryResultsIterable<? extends org.vertexium.VertexiumObject> extendedData(FetchHints fetchHints, Iterable<? extends Element> elements) {
    ...
    public QueryResultsIterable<ExtendedDataRowId> extendedDataRowIds(EnumSet<IdFetchHint> idFetchHints) {
        FetchHints fetchHints = idFetchHintsToElementFetchHints(idFetchHints);
        QueryResultsIterable<? extends org.vertexium.VertexiumObject> vertexiumObjects = search(EnumSet.of(VertexiumObjectType.EXTENDED_DATA), fetchHints);
    ...
    public static abstract class HasContainer {
        public abstract boolean isMatch(org.vertexium.VertexiumObject elem);
    ...
    private static abstract class HasContainerSplitElementExtendedDataRows extends HasContainer {
        @Override
        public boolean isMatch(org.vertexium.VertexiumObject vertexiumObject) {
        ...
        protected boolean isPropertyOfType(org.vertexium.PropertyDefinition propertyDefinition, Class dataType) {
    ...
    public static class HasValueContainer extends HasContainerSplitElementExtendedDataRows {
        ...
        //todo private
        public final Collection<org.vertexium.PropertyDefinition> propertyDefinitions;

        public HasValueContainer(String key, Predicate predicate, Object value, Collection<org.vertexium.PropertyDefinition> propertyDefinitions) {
            this(Collections.singleton(key), predicate, value, propertyDefinitions);
        }

        public HasValueContainer(Iterable<String> keys, Predicate predicate, Object value, Collection<org.vertexium.PropertyDefinition> propertyDefinitions) {
        ...
        public HasValueContainer(Class dataType, Predicate predicate, Object value, Collection<org.vertexium.PropertyDefinition> propertyDefinitions) {
            this.value = value;
            this.predicate = predicate;
            this.keys = propertyDefinitions.stream()
                    .filter(propertyDefinition -> isPropertyOfType(propertyDefinition, dataType))
                    .map(org.vertexium.PropertyDefinition::getPropertyName)
        ...
        private void validateParameters() {
            this.keys.forEach(key -> {
                org.vertexium.PropertyDefinition propertyDefinition = org.vertexium.PropertyDefinition.findPropertyDefinition(propertyDefinitions, key);
        ...
        protected boolean isMatch(ExtendedDataRow extendedDataRow) {
            for (Property property : extendedDataRow.getProperties()) {
                if (this.keys.contains(property.getName())) {
                    org.vertexium.PropertyDefinition propertyDefinition = org.vertexium.PropertyDefinition.findPropertyDefinition(this.propertyDefinitions, property.getName());
    ...
    public static class HasExtendedData extends HasContainer {
        ...
        @Override
        public boolean isMatch(org.vertexium.VertexiumObject elem) {
    ...
    public static class HasPropertyContainer extends HasContainerSplitElementExtendedDataRows {
        ...
        public HasPropertyContainer(Class dataType, Collection<org.vertexium.PropertyDefinition> propertyDefinitions) {
            this.keys = propertyDefinitions.stream()
                    .filter(propertyDefinition -> isPropertyOfType(propertyDefinition, dataType))
                    .map(org.vertexium.PropertyDefinition::getPropertyName)
                    .collect(Collectors.toSet());
    ...
    public static class HasNotPropertyContainer extends HasContainerSplitElementExtendedDataRows {
        ...
        public HasNotPropertyContainer(Class dataType, Collection<org.vertexium.PropertyDefinition> propertyDefinitions) {
            this.keys = propertyDefinitions.stream()
                    .filter(propertyDefinition -> isPropertyOfType(propertyDefinition, dataType))
