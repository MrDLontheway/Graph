...
public abstract class GraphBase implements Graph {
    ...
    private Map<String, org.vertexium.PropertyDefinition> propertyDefinitionCache = new HashMap<>();
    ...
    @Override
    public Iterable<Vertex> addVertices(Iterable<org.vertexium.ElementBuilder<Vertex>> vertices, Authorizations authorizations) {
    ...
    public DefinePropertyBuilder defineProperty(String propertyName) {
        return new DefinePropertyBuilder(propertyName) {
            @Override
            public org.vertexium.PropertyDefinition define() {
                org.vertexium.PropertyDefinition propertyDefinition = super.define();
    ...
    protected void addToPropertyDefinitionCache(org.vertexium.PropertyDefinition propertyDefinition) {
        propertyDefinitionCache.put(propertyDefinition.getPropertyName(), propertyDefinition);
    }

    public void savePropertyDefinition(org.vertexium.PropertyDefinition propertyDefinition) {
    ...
    @Override
    public org.vertexium.PropertyDefinition getPropertyDefinition(String propertyName) {
        //todo propertyName
        propertyName = propertyName.replace(".","-");
        org.vertexium.PropertyDefinition propertyDefinition = propertyDefinitionCache.get(propertyName);
        if (propertyDefinition != null) {
            return propertyDefinition;
        }
        propertyDefinition = (org.vertexium.PropertyDefinition) getMetadata(getPropertyDefinitionKey(propertyName));
        if (propertyDefinition != null) {
    ...
    public void ensurePropertyDefined(String name, Object value) {
        ...
        propertyDefinition = new org.vertexium.PropertyDefinition(name, valueClass, TextIndexHint.ALL);
