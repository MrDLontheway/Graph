...
public class AccumuloGraph extends GraphBaseWithSearchIndex implements Traceable {
    ...
    static final AccumuloGraphLogger GRAPH_LOGGER = new AccumuloGraphLogger(org.vertexium.GraphBase.QUERY_LOGGER);
        ...
        return new AccumuloVertexBuilder(finalVertexId, visibility, elementMutationBuilder) {
            ...
            public Vertex save(Authorizations authorizations) {
                ...
                try {
                    ...
                    org.vertexium.accumulo.AccumuloVertex vertex = createVertex(authorizations);
            ...
            @Override
            protected org.vertexium.accumulo.AccumuloVertex createVertex(Authorizations authorizations) {
                Iterable<Visibility> hiddenVisibilities = null;
                return new org.vertexium.accumulo.AccumuloVertex(
                        AccumuloGraph.this,
                        getElementId(),
                        getVisibility(),
                        getProperties(),
    ...
    private void queueEvents(
            org.vertexium.accumulo.AccumuloElement element,
    ...
    void deleteProperty(org.vertexium.accumulo.AccumuloElement element, Property property, Authorizations authorizations) {
        ...
        getSearchIndex().deleteProperty(
                this,
                element,
                org.vertexium.PropertyDescriptor.fromProperty(property),
                authorizations
        );
    ...
    void softDeleteProperty(org.vertexium.accumulo.AccumuloElement element, Property property, Authorizations authorizations) {
        Mutation m = new Mutation(element.getId());
    ...
    private Mutation[] getDeleteExtendedDataMutations(ExtendedDataRowId rowId) {
        ...
        m.put(org.vertexium.accumulo.AccumuloElement.DELETE_ROW_COLUMN_FAMILY, org.vertexium.accumulo.AccumuloElement.DELETE_ROW_COLUMN_QUALIFIER, RowDeletingIterator.DELETE_ROW_VALUE);
        mutations[0] = m;
        return mutations;
    }
                ...
                try {
                    AddEdgeToVertexRunnable addEdgeToVertex = new AddEdgeToVertexRunnable() {
                        ...
                        public void run(AccumuloEdge edge) {
                            if (getOutVertex() instanceof org.vertexium.accumulo.AccumuloVertex) {
                                ((org.vertexium.accumulo.AccumuloVertex) getOutVertex()).addOutEdge(edge);
                            }
                            if (getInVertex() instanceof org.vertexium.accumulo.AccumuloVertex) {
                                ((org.vertexium.accumulo.AccumuloVertex) getInVertex()).addInEdge(edge);
                            }
                        }
                    };
                    //todo add edge long id
        ...
        try {
            ...
            try {
                ...
                for (Map.Entry<Key, Value> column : scanner) {
                    ...
                    if (column.getKey().getColumnFamily().equals(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY)) {
                    ...
                    } else if (column.getKey().getColumnFamily().equals(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_SOFT_DELETE)) {
                        PropertyColumnQualifier propertyColumnQualifier = KeyHelper.createPropertyColumnQualifier(cq, getNameSubstitutionStrategy());
                        String propertyKey = propertyColumnQualifier.getPropertyKey();
                        String propertyName = propertyColumnQualifier.getPropertyName();
                    ...
                    } else if (column.getKey().getColumnFamily().equals(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_METADATA)) {
    ...
    public void deleteEdge(Edge edge, Authorizations authorizations) {
        ...
        try {
            ...
            outMutation.putDelete(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE, new Text(edge.getId()), visibility);

            Mutation inMutation = new Mutation(edge.getVertexId(Direction.IN));
            inMutation.putDelete(org.vertexium.accumulo.AccumuloVertex.CF_IN_EDGE, new Text(edge.getId()), visibility);
    ...
    public void softDeleteEdge(Edge edge, Long timestamp, Authorizations authorizations) {
        ...
        try {
            ...
            Mutation outMutation = new Mutation(edge.getVertexId(Direction.OUT));
            outMutation.put(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE_SOFT_DELETE, new Text(edge.getId()), visibility, timestamp, org.vertexium.accumulo.AccumuloElement.SOFT_DELETE_VALUE);

            Mutation inMutation = new Mutation(edge.getVertexId(Direction.IN));
            inMutation.put(org.vertexium.accumulo.AccumuloVertex.CF_IN_EDGE_SOFT_DELETE, new Text(edge.getId()), visibility, timestamp, org.vertexium.accumulo.AccumuloElement.SOFT_DELETE_VALUE);
    ...
    public void markEdgeHidden(Edge edge, Visibility visibility, Authorizations authorizations) {
        ...
        try {
            ...
            outMutation.put(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE_HIDDEN, new Text(edge.getId()), columnVisibility, org.vertexium.accumulo.AccumuloElement.HIDDEN_VALUE);

            Mutation inMutation = new Mutation(in.getId());
            inMutation.put(org.vertexium.accumulo.AccumuloVertex.CF_IN_EDGE_HIDDEN, new Text(edge.getId()), columnVisibility, org.vertexium.accumulo.AccumuloElement.HIDDEN_VALUE);
            ...
            if (out instanceof org.vertexium.accumulo.AccumuloVertex) {
                ((org.vertexium.accumulo.AccumuloVertex) out).removeOutEdge(edge);
            }
            if (in instanceof org.vertexium.accumulo.AccumuloVertex) {
                ((org.vertexium.accumulo.AccumuloVertex) in).removeInEdge(edge);
            }
    ...
    public void markEdgeVisible(Edge edge, Visibility visibility, Authorizations authorizations) {
        ...
        try {
            ...
            Mutation outMutation = new Mutation(out.getId());
            outMutation.putDelete(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE_HIDDEN, new Text(edge.getId()), columnVisibility);

            Mutation inMutation = new Mutation(in.getId());
            inMutation.putDelete(org.vertexium.accumulo.AccumuloVertex.CF_IN_EDGE_HIDDEN, new Text(edge.getId()), columnVisibility);
            ...
            if (out instanceof org.vertexium.accumulo.AccumuloVertex) {
                ((org.vertexium.accumulo.AccumuloVertex) out).addOutEdge(edge);
            }
            if (in instanceof org.vertexium.accumulo.AccumuloVertex) {
                ((org.vertexium.accumulo.AccumuloVertex) in).addInEdge(edge);
            }
    ...
    private Mutation getMarkHiddenPropertyMutation(String rowKey, Property property, long timestamp, ColumnVisibility visibility) {
        ...
        m.put(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_HIDDEN, columnQualifier, visibility, timestamp, org.vertexium.accumulo.AccumuloElement.HIDDEN_VALUE);
        return m;
    }

    @SuppressWarnings("unused")
    public void markPropertyVisible(org.vertexium.accumulo.AccumuloElement element, Property property, Long timestamp, Visibility visibility, Authorizations authorizations) {
        checkNotNull(element);
    ...
    private Mutation getMarkVisiblePropertyMutation(String rowKey, Property property, long timestamp, ColumnVisibility visibility) {
        Mutation m = new Mutation(rowKey);
        Text columnQualifier = KeyHelper.getColumnQualifierFromPropertyHiddenColumnQualifier(property, getNameSubstitutionStrategy());
        m.put(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_HIDDEN, columnQualifier, visibility, timestamp, org.vertexium.accumulo.AccumuloElement.HIDDEN_VALUE_DELETED);
        return m;
    }
    ...
    private Mutation getSoftDeleteRowMutation(String rowKey, long timestamp) {
        Mutation m = new Mutation(rowKey);
        m.put(org.vertexium.accumulo.AccumuloElement.CF_SOFT_DELETE, org.vertexium.accumulo.AccumuloElement.CQ_SOFT_DELETE, timestamp, org.vertexium.accumulo.AccumuloElement.SOFT_DELETE_VALUE);
        return m;
    }

    private Mutation getMarkHiddenRowMutation(String rowKey, ColumnVisibility visibility) {
        Mutation m = new Mutation(rowKey);
        m.put(org.vertexium.accumulo.AccumuloElement.CF_HIDDEN, org.vertexium.accumulo.AccumuloElement.CQ_HIDDEN, visibility, org.vertexium.accumulo.AccumuloElement.HIDDEN_VALUE);
        return m;
    }

    private Mutation getMarkVisibleRowMutation(String rowKey, ColumnVisibility visibility) {
        Mutation m = new Mutation(rowKey);
        m.putDelete(org.vertexium.accumulo.AccumuloElement.CF_HIDDEN, org.vertexium.accumulo.AccumuloElement.CQ_HIDDEN, visibility);
        return m;
    }
    ...
    public static Iterable<Text> getColumnFamiliesToFetch(ElementType elementType, FetchHints fetchHints) {
        ...
        columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_HIDDEN);
        columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_SOFT_DELETE);
        columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.DELETE_ROW_COLUMN_FAMILY);

        if (elementType == ElementType.VERTEX) {
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloVertex.CF_SIGNAL);
        } else if (elementType == ElementType.EDGE) {
        ...
        if (fetchHints.isIncludeAllEdgeRefs()
            ...
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloVertex.CF_IN_EDGE);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloVertex.CF_IN_EDGE_HIDDEN);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloVertex.CF_IN_EDGE_SOFT_DELETE);
        }
        if (fetchHints.isIncludeAllEdgeRefs()
                || fetchHints.isIncludeOutEdgeRefs()
                || fetchHints.isIncludeEdgeLabelsAndCounts()
                || fetchHints.hasEdgeLabelsOfEdgeRefsToInclude()) {
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE_HIDDEN);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE_SOFT_DELETE);
        }
        if (fetchHints.isIncludeProperties()) {
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_HIDDEN);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_SOFT_DELETE);
        }
        if (fetchHints.isIncludePropertyMetadata()) {
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_METADATA);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_HIDDEN);
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_PROPERTY_SOFT_DELETE);
        }
        if (fetchHints.isIncludeExtendedDataTableNames()) {
            columnFamiliesToFetch.add(org.vertexium.accumulo.AccumuloElement.CF_EXTENDED_DATA);
        }
    ...
    void alterElementVisibility(org.vertexium.accumulo.AccumuloElement element, Visibility newVisibility) {
        String elementRowKey = element.getId();
    ...
    void alterElementPropertyVisibilities(org.vertexium.accumulo.AccumuloElement element, List<AlterPropertyVisibility> alterPropertyVisibilities) {
        ...
        List<org.vertexium.PropertyDescriptor> propertyList = Lists.newArrayList();
        for (AlterPropertyVisibility apv : alterPropertyVisibilities) {
            ...
            propertyList.add(org.vertexium.PropertyDescriptor.from(apv.getKey(), apv.getName(), apv.getExistingVisibility()));
        }
    ...
    void alterPropertyMetadatas(org.vertexium.accumulo.AccumuloElement element, List<SetPropertyMetadata> setPropertyMetadatas) {
        ...
        try {
            ...
            try {
                ...
                for (Map.Entry<Key, Value> row : scanner) {
                    ...
                    if (!columnFamily.equals(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE)) {
                        if (columnFamily.equals(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE_SOFT_DELETE) || columnFamily.equals(org.vertexium.accumulo.AccumuloVertex.CF_OUT_EDGE_HIDDEN)) {
    ...
    private Vertex createVertexFromVertexIteratorValue(Key key, Value value, FetchHints fetchHints, Authorizations authorizations) {
        return org.vertexium.accumulo.AccumuloVertex.createFromIteratorValue(this, key, value, fetchHints, authorizations);
    }
    ...
    private class AccumuloGraphMetadataStore extends GraphMetadataStore {
        ...
        public void setMetadata(String key, Object value) {
            ...
            try {
                ...
                m.put(org.vertexium.accumulo.AccumuloElement.METADATA_COLUMN_FAMILY, AccumuloElement.METADATA_COLUMN_QUALIFIER, new Value(valueBytes));
    ...
    //TODO edge ASYNC
    public Iterable<Edge> addEdgesAsync(Iterable<org.vertexium.ElementBuilder<Edge>> edges, Authorizations authorizations) {
        List<Edge> addedEdges = new ArrayList<>();
        for (org.vertexium.ElementBuilder<Edge> edgeBuilder : edges) {
    ...
    //TODO vertex ASYNC
    public Iterable<Vertex> addVerticesAsync(Iterable<org.vertexium.ElementBuilder<Vertex>> vertices, Authorizations authorizations) {
