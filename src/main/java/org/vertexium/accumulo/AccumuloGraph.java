...
public class AccumuloGraph extends GraphBaseWithSearchIndex implements Traceable {
    ...
    //TODO edge ASYNC
    public Iterable<Edge> addEdgesAsync(Iterable<ElementBuilder<Edge>> edges, Authorizations authorizations) {
    ...
    //TODO vertex ASYNC
    public Iterable<Vertex> addVerticesAsync(Iterable<ElementBuilder<Vertex>> vertices, Authorizations authorizations) {
