...
//            searchIndex1.addElement(defaultGraph,mev1,auth);
        ...
        org.vertexium.ElementBuilder<Vertex> vertexElementBuilder = defaultGraph.prepareVertex("testdl", Visibility.EMPTY)
...
//                v.skip(5);
//                v.limit(12);
                QueryResultsIterable<? extends org.vertexium.VertexiumObject> search = v.search(EnumSet.of(VertexiumObjectType.VERTEX), defaultGraph.getDefaultFetchHints());
                Iterator<? extends org.vertexium.VertexiumObject> iterator = search.iterator();
                search.forEach(x -> {
                    System.out.println("vertexID:" + x);
                });
...
//        });
    ...
    public static void main(String[] args) {
        ...
        org.vertexium.query.QueryBase.HasValueContainer hasValueContainer = new QueryBase.HasValueContainer("article", Compare.EQUAL, 123, defaultGraph.getPropertyDefinitions());
...
//        }
        ...
        ArrayList<org.vertexium.ElementBuilder<Vertex>> vs = new ArrayList<>();
