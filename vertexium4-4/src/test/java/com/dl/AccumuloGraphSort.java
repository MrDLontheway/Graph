...
//        }
        defaultGraph.flush();
        Collection<org.vertexium.PropertyDefinition> propertyDefinitions = defaultGraph.getPropertyDefinitions();
...
//        defaultGraph.savePropertyDefinition(new PropertyDefinition("com-scistor-property-age2",Integer.class,textIndexHints,null,true));
    ...
    public void tmp1(){
        ...
        textIndexHints.add(TextIndexHint.EXACT_MATCH);
        textIndexHints.add(TextIndexHint.FULL_TEXT);
        defaultGraph.savePropertyDefinition(new org.vertexium.PropertyDefinition("com-scistor-property-age2",Integer.class,textIndexHints,null,true));
        defaultGraph.flush();

        Random r=  new Random();
        ArrayList<org.vertexium.ElementBuilder<Vertex>> eb = new ArrayList<>();
...
//            vertexBuilder.save(auth);
    ...
    public void pro(){
        ...
        defaultGraph.getPropertyDefinitions().forEach(x->{
            org.vertexium.PropertyDefinition propertyDefinition = new PropertyDefinition(x.getPropertyName(), x.getDataType(), x.getTextIndexHints(), null, true);
