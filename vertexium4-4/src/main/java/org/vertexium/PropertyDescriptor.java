...
public class PropertyDescriptor {
    ...
    public static PropertyDescriptor from(String key, String name, Visibility visibility) {
        //todo changge name replace
        return new PropertyDescriptor(key, name.replace(".","-"), visibility);
    }

    public static PropertyDescriptor fromProperty(Property p) {
        //todo changge name replace
        return new PropertyDescriptor(p.getKey(), p.getName().replace(".","-"), p.getVisibility());
    }
