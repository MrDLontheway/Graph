...
public class AccumuloGraph extends GraphBaseWithSearchIndex implements Traceable {
    ...
    private Mutation[] getDeleteExtendedDataMutations(ExtendedDataRowId rowId) {
        ...
        Text rowKey = org.vertexium.accumulo.keys.KeyHelper.createExtendedDataRowKey(rowId);
            ...
            try {
                ...
                for (Map.Entry<Key, Value> column : scanner) {
                    ...
                    if (column.getKey().getColumnFamily().equals(AccumuloElement.CF_PROPERTY)) {
                        ...
                        PropertyColumnQualifier propertyColumnQualifier = org.vertexium.accumulo.keys.KeyHelper.createPropertyColumnQualifier(cq, getNameSubstitutionStrategy());
                        ...
                        PropertyMetadataColumnQualifier propertyMetadataColumnQualifier = org.vertexium.accumulo.keys.KeyHelper.createPropertyMetadataColumnQualifier(cq, getNameSubstitutionStrategy());
    ...
    public Iterable<ExtendedDataRow> getExtendedData(
        ...
        try {
            ...
            org.apache.accumulo.core.data.Range range = org.apache.accumulo.core.data.Range.prefix(org.vertexium.accumulo.keys.KeyHelper.createExtendedDataRowKey(elementType, elementId, tableName, ""));
    ...
    public Iterable<ExtendedDataRow> getExtendedDataInRange(ElementType elementType, Range elementIdRange, Authorizations authorizations) {
        Range extendedDataRowKeyRange = org.vertexium.accumulo.keys.KeyHelper.createExtendedDataRowKeyRange(elementType, elementIdRange);
    ...
    private List<org.apache.accumulo.core.data.Range> extendedDataRowIdToRange(Iterable<ExtendedDataRowId> ids) {
        return stream(ids)
                .map(id -> org.apache.accumulo.core.data.Range.prefix(org.vertexium.accumulo.keys.KeyHelper.createExtendedDataRowKey(id)))
    ...
    private Mutation getMarkHiddenPropertyMutation(String rowKey, Property property, long timestamp, ColumnVisibility visibility) {
        Mutation m = new Mutation(rowKey);
        Text columnQualifier = org.vertexium.accumulo.keys.KeyHelper.getColumnQualifierFromPropertyHiddenColumnQualifier(property, getNameSubstitutionStrategy());
    ...
    public Iterable<Vertex> addVerticesAsync(Iterable<org.vertexium.ElementBuilder<Vertex>> vertices, Authorizations authorizations) {
        ...
        for (org.vertexium.ElementBuilder<Vertex> vertexBuilder : vertices) {
